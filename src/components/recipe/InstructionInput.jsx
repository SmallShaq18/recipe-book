...
function SortableInstruction({ id, value, onChange, onRemove, index }) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    ...
    >
      <button
        type="button"
        className="btn btn-sm btn-outline-secondary border-0 p-1 mt-1"
        {...attributes}
        {...listeners}
        style={{ cursor: 'grab' }}
      >
      ...
      <div className="flex-grow-1">
        <div className="d-flex align-items-center mb-2">
          <span className="badge bg-primary me-2">Step {index + 1}</span>
        </div>
        <textarea
